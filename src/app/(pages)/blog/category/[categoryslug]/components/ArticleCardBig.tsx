...
const ArticleCardBig = ({ article }: any) => {
  const el = article;
  ...
  return (
    ...
    >
      <article className="overflow-hidden flex w-full grow h-full relative border-2 rounded-xl flex-col bg-white  text-gray-15 dark:border-gray-1F dark:text-white dark:bg-gray-1F">
        <div className="">
        ...
        <div className="flex h-full gap-4 f p-8 flex-col">
          <div className="flex justify-between items-center gap-4">
            ...
            <span className="shrink-0 text-gray-50 dark:text-white">
          ...
          <div className="flex flex-col gap-4 flex-grow">
            ...
            >
              <h2 className="font-headings tracking-tight scroll-mt-[120px] text-2xl  font-medium">
                {title}
              </h2>
            </Link>
          </div>
