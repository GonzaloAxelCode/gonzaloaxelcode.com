  ...
  return (
    <div style={{ opacity: 1, transform: "none" }} className="grid grid-cols-1 lg:grid-cols-2 gap-4 ">
      {data?.map((el: any, index: any) => {
        ...
        return <div key={index} className="border-0 dark:border-darkborder  rounded-xl relative bg-gray-F7 dark:bg-blackbgsection flex items-center transition-all hover:shadow-playbook-box-hover h-full ">
          <div className="w-[70%] p-6 sm:p-10 pr-0">
