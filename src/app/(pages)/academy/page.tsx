        ...
        <article className="container text-md">
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 py-8">
              <div>
                ...
                <p className="mb-5  font-headings text-gray-A4">
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-6 mt-12">
                ...
                <div className="flex w-full p-6 sm:flex-row   border-2 rounded-xl border-gray-30 hover:border-gray-1F">
                  ...
                  <div className="flex h-full gap-4 f justify-between w-full flex-col sm:ml-12">
                    <div className="flex  justify-between items-center gap-4">
                      <span className=" flex tracking-tight items-center gap-1.5 relative h-6 font-bold text-sm-flat text-gray-15">
                        <a
                        ...
                        >
                          ...
                          <span className="text-base text-gray-A4">
                            Lesson one
                          </span>
                        </a>
                      </span>
                      <div className="flex items-center gap-1.5">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 512 512"
                          className="inline-block w-5 h-5 fill-gray-A4"
                        >
                          <path d="M464 256a208 208 0 1 1-416 0 208 208 0 1 1 416 0zM0 256a256 256 0 1 0 512 0 256 256 0 1 0-512 0zm232-136v136c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2V120c0-13.3-10.7-24-24-24s-24 10.7-24 24z" />
                        </svg>
                        <span className="shrink-0 text-gray-A4 text-sm">
                          17:12
                        </span>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <span className="block text-gray-A4">
              ...
              <div className="w-full flex">
                <div className="flex w-full p-6 sm:flex-row   border-2 rounded-xl border-gray-30 hover:border-gray-1F">
                  <a
                    className="shrink-0 sm:w-[160px] xl:w-[260px]"
                    href="/academy/prismic-and-nextjs/3-the-page-builder/1-lesson-3-overview"
                  >
                    <div
                      className="aspect-[258/145] bg-primary-purple bg-cover bg-no-repeat bg-center rounded-md"
                      style={{
                        backgroundImage:
                          'url("https://images.prismic.io/prismic-academy/652e40e5fbd9a45bcec81775_00000.png?auto=format%2Ccompress&rect=10%2C0%2C3820%2C2160&w=260&h=147")',
                      }}
                    />
                  </a>
                  <div className="flex h-full gap-4 f justify-between w-full flex-col sm:ml-12">
                    ...
                    >
                      ...
                      <span className="block text-gray-A4">
                        This lesson will go over the basics of the Prismic
                        content editor and guide you in building your first
                        page.
                      </span>
                    </a>
                  </div>
              ...
              <div className="w-full flex">
                <div className="flex w-full p-6 sm:flex-row   border-2 rounded-xl border-gray-30 hover:border-gray-1F">
                  <a
                    className="shrink-0 sm:w-[160px] xl:w-[260px]"
                    href="/academy/prismic-and-nextjs/4-querying-prismic-content/1-lesson-4-overview"
                  >
                    <div
                      className="aspect-[258/145] bg-primary-purple bg-cover bg-no-repeat bg-center rounded-md"
                      style={{
                        backgroundImage:
                          'url("https://images.prismic.io/prismic-academy/652e5130fbd9a45bcec81777_00000.png?auto=format%2Ccompress&rect=10%2C0%2C3820%2C2160&w=260&h=147")',
                      }}
                    />
                  </a>
                  <div className="flex h-full gap-4 f justify-between w-full flex-col sm:ml-12">
                    ...
                    >
                      ...
                      <span className="block text-gray-A4">
                        This lesson will teach you the basics of querying the
                        Prismic API.
                      </span>
                    </a>
                  </div>
              ...
              <div className="w-full hidden">
                <div className="flex w-full p-6 sm:flex-row   border-2 rounded-xl border-gray-30 hover:border-gray-1F">
                  <a
                    className="shrink-0 sm:w-[160px] xl:w-[260px]"
                    href="/academy/prismic-and-nextjs/5-add-content-to-your-html/1-lesson-5-overview"
                  >
                    <div
                      className="aspect-[258/145] bg-primary-purple bg-cover bg-no-repeat bg-center rounded-md"
                      style={{
                        backgroundImage:
                          'url("https://images.prismic.io/prismic-academy/652e6fdafbd9a45bcec81792_00000.png?auto=format%2Ccompress&rect=10%2C0%2C3820%2C2160&w=260&h=147")',
                      }}
                    />
                  </a>
                  <div className="flex h-full gap-4 f justify-between w-full flex-col sm:ml-12">
                    ...
                    >
                      ...
                      <span className="block text-gray-A4">
                        This lesson will teach you to turn the API response JSON
                        into HTML.
                      </span>
                    </a>
                  </div>
              ...
              <div className="w-full hidden">
                <div className="flex w-full p-6 sm:flex-row   border-2 rounded-xl border-gray-30 hover:border-gray-1F">
                  <a
                    className="shrink-0 sm:w-[160px] xl:w-[260px]"
                    href="/academy/prismic-and-nextjs/6-variations-and-simulating-slices/1-create-your-first-variation"
                  >
                    <div
                      className="aspect-[258/145] bg-primary-purple bg-cover bg-no-repeat bg-center rounded-md"
                      style={{
                        backgroundImage:
                          'url("https://images.prismic.io/prismic-academy/652e739ffbd9a45bcec81796_00000.png?auto=format%2Ccompress&rect=10%2C0%2C3820%2C2160&w=260&h=147")',
                      }}
                    />
                  </a>
                  <div className="flex h-full gap-4 f justify-between w-full flex-col sm:ml-12">
                    ...
                    >
                      ...
                      <span className="block text-gray-A4">
                        By the end of this lesson, you will be able to create
                        variations and simulate the output.
                      </span>
                    </a>
                  </div>
                </div>
              ...
              <div className="w-full hidden">
                <div className="flex w-full p-6 sm:flex-row   border-2 rounded-xl border-gray-30 hover:border-gray-1F">
                  <a
                    className="shrink-0 sm:w-[160px] xl:w-[260px]"
                    href="/academy/prismic-and-nextjs/7-dynamic-routes-and-pages/1-new-page-type-request"
                  >
                    <div
                      className="aspect-[258/145] bg-primary-purple bg-cover bg-no-repeat bg-center rounded-md"
                      style={{
                        backgroundImage:
                          'url("https://images.prismic.io/prismic-academy/652e7645fbd9a45bcec81799_00000.png?auto=format%2Ccompress&rect=10%2C0%2C3820%2C2160&w=260&h=147")',
                      }}
                    />
                  </a>
                  <div className="flex h-full gap-4 f justify-between w-full flex-col sm:ml-12">
                    ...
                    >
                      ...
                      <span className="block text-gray-A4">
                        This lesson will show you how to model and query dynamic
                        pages.
                      </span>
                    </a>
                  </div>
              ...
              <div className="w-full hidden">
                <div className="flex w-full p-6 sm:flex-row   border-2 rounded-xl border-gray-30 hover:border-gray-1F">
                  <a
                    className="shrink-0 sm:w-[160px] xl:w-[260px]"
                    href="/academy/prismic-and-nextjs/8-links-and-navigation/1-adding-links-and-resolving-routes"
                  >
                    <div
                      className="aspect-[258/145] bg-primary-purple bg-cover bg-no-repeat bg-center rounded-md"
                      style={{
                        backgroundImage:
                          'url("https://images.prismic.io/prismic-academy/652e7921fbd9a45bcec8179b_00000.png?auto=format%2Ccompress&rect=10%2C0%2C3820%2C2160&w=260&h=147")',
                      }}
                    />
                  </a>
                  <div className="flex h-full gap-4 f justify-between w-full flex-col sm:ml-12">
                    ...
                    >
                      ...
                      <span className="block text-gray-A4">
                        This lesson will show you how to resolve Prismic links
                        and create a menu.
                      </span>
                    </a>
                  </div>
              ...
              <div className="w-full hidden">
                <div className="flex w-full p-6 sm:flex-row   border-2 rounded-xl border-gray-30 hover:border-gray-1F">
                  <a
                    className="shrink-0 sm:w-[160px] xl:w-[260px]"
                    href="/academy/prismic-and-nextjs/9-content-changes-and-previews/1-lesson-9-overview"
                  >
                    <div
                      className="aspect-[258/145] bg-primary-purple bg-cover bg-no-repeat bg-center rounded-md"
                      style={{
                        backgroundImage:
                          'url("https://images.prismic.io/prismic-academy/652e7a99fbd9a45bcec8179c_00000.png?auto=format%2Ccompress&rect=10%2C0%2C3820%2C2160&w=260&h=147")',
                      }}
                    />
                  </a>
                  <div className="flex h-full gap-4 f justify-between w-full flex-col sm:ml-12">
                    ...
                    >
                      ...
                      <span className="block text-gray-A4">
                        Learn how to trigger website updates, see value of
                        content previews and how to configure them.
                      </span>
                    </a>
                  </div>
                </div>
            ...
            <div className="mt-6 text-center">
              <button className="rounded-lg font-bold whitespace-nowrap focus:outline-none focus:ring-tertiary-purple disabled:opacity-50 group border-2 focus:ring-4 transition-opacity transition-colors hover:bg-opacity-75 disabled:hover:bg-opacity-100 border-white py-3 px-6 text-sm-flat leading-5 2xl:text-base-flat 2xl:leading-5 bg-white text-gray-15">
                Show all lessons
              </button>
            </div>
          </section>
