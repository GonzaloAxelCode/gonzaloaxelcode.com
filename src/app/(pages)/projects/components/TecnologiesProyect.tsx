...
let LIST_TECNOLOGIES = {
  JAVASCRIPT: "https://cdn.svgporn.com/logos/javascript.svg",
  REACTJS: "https://cdn.svgporn.com/logos/react.svg",
  ...
  VERCEL:
    "https://res.cloudinary.com/ddksrkond/image/upload/v1700317942/LOGOS/68747470733a2f2f6173736574732e76657263656c2e636f6d2f696d6167652f75706c6f61642f76313538383830353835382f7265706f7369746f726965732f76657263656c2f6c6f676f2e706e67_ne3knl.png",
...
const TecnologiesProyect = ({ tecnologias }: any) => {
  return (
    <div
      className="all-tools "
      style={{
    ...
    >
      {tecnologias?.map((el: any, index: any) => (
        <Tool
          key={index}
          name={el.name}
          url={LIST_TECNOLOGIES[el.name.toUpperCase().trim()]}
        />
      ))}
    </div>
  );
