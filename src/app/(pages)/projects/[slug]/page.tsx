    ...
    <main className="px-5 md:px-10">
      ...
      <section className="relative z-10 my-12 flex flex-col min-h-dvh font-copy font-medium antialiased selection:bg-primary-purple selection:text-white">
        <div className=" mx-auto flex flex-col">
          ...
          <div className="flex gap-9  container justify-center flex-wrap lg:flex-nowrap items-center overflow-hidden slice-layout w-full ">
            <div className="  md:grid md:grid-cols-6 relative z-10">
              <div className="md:col-span-6 md:pr-4">
                <div className="flex items-center gap-1 mb-6">
                  <span className="text-sm py-0.5 px-1.5 rounded-md font-bold border-2 flex items-centers gap-1 bg-gray-15 border-gray-15 text-white">
                    {category}
                  </span>
                  <span className="text-sm py-0.5 px-1.5 rounded-md font-bold border-2 flex items-centers gap-1 bg-quaternary-orange text-primary-orange border-tertiary-orange">
                    <svg
                      width={16}
                      height={16}
                      viewBox="0 0 16 16"
            ...
            <div className=" mt-6 sm:mt-0">
              <picture>
                <Image
                  ...
                  src={cover}
                  className="object-cover  border-2  border-gray-100 dark:border-darkborder rounded-200 border-solid"
                  alt="s"
                />
              </picture>
              <P className="text-xs italic font-light my-2">
                Ultima actualizacion el 30 de Julio del 2024
              </P>
            </div>
          </div>
            ...
            <div className="col-span-3 md:col-span-4">
              <div className="flex gap-4 items-center sticky top-[120px]">
                <img
                  ...
                  src="https://res.cloudinary.com/ddksrkond/image/upload/c_crop,ar_1:1/v1700110843/SEO/WhatsApp_Image_2023-11-15_at_11.58.48_PM_pvgump.jpg"
                ...
                <div className="relative hidden md:flex md:flex-col md:gap-1 pt-3">
                  ...
                  <div className="font-copy text-base font-medium print:text-[10px] print:text-justify text-gray-50">
                    July 24, 2024
                  </div>
                </div>
              </div>
            ...
            <div className="col-span-9 md:col-span-6 pt-1">
              <header className="flex flex-col gap-1 mb-10">
                <div className="relative md:hidden mb-6">
                  ...
                  <div className="font-copy text-xs font-medium text-gray-50">
                    July 24, 2024
                  </div>
                </div>
                <p className=" scroll-mt-[120px] lg:text-3xl-tight 2xl:text-4xl  wrap-balance">
                  New helpers are released in beta
                </p>
                <div className="flex gap-x-2 items-center flex-wrap font-bold">
                  <svg
                    width={14}
                    height={14}
                    viewBox="0 0 14 14"
                  ...
                  <span className="after:content-[','] last:after:content-none">
                    <a
                      className="underline underline-offset-8 focus:ring-4 hover:underline-offset-4 border-gray-15 text-sm-flat leading-5 2xl:text-base-flat 2xl:leading-5"
                      href="/updates/migration-api"
                    >
                      Migrate your content to Prismic with speed and
                      confidence
                    </a>
                  </span>
                </div>
