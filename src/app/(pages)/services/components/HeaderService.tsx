...
const HeaderService = () => {
  return (
    <div>
      <div className="slice-layout w-full text-white py-12 md:py-15 2xl:py-15 relative">
        <div className="container mx-auto items-center relative z-10 md:py-[5vh] 2xl:py-[9vh]">
          <div className=" mx-auto text-center flex flex-col items-center relative z-10">
            ...
            <p className="mb-5 px-4 md:px-20  text-3xl sm:text-3xl text-gray-15 dark:text-white md:text-4xl font-headings text-gray-A4" style={{
              letterSpacing: "-.025em",
              lineHeight: 1.083,
            }}>
              <strong>
      ...
      <div className=" border-2 rounded-xl mt-4 first:mt-0 relative z-10 overflow-hidden mx-[5%] md:mx-[10%]   border-darkborder bg-white  dark:bg-blackbg ">
       
        <div className="p-6 pt-12">
          <div className="text-center">
            <span className="font-headings  text-3xl font-semibold tracking-tight">
